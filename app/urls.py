...
urlpatterns = [
    ...
    path("password_confirmation/", views.PasswordConfirmationView.as_view(), name="password_change_done"),
    path("password/", auth_views.PasswordChangeView.as_view(template_name='password_change.html'), name="password"),
