...
urlpatterns = [
    ...
    path("password_change_confirmation/", views.PasswordChangeConfirmationView.as_view(), name="password_change_done"),
    path("password_reset/", auth_views.PasswordResetView.as_view(template_name='password_reset.html'), name="password_reset"),
    path("password_reset_confirmation/", views.PasswordResetConfirmationView.as_view(), name="password_reset_done"),
